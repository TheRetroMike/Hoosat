...
// RPCTransaction is a hoosatd transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a hoosatd transaction input representation
...
// RPCScriptPublicKey is a hoosatd ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a hoosatd transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a hoosatd outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a hoosatd utxo entry representation meant to be used
// over RPC
