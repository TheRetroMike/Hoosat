...
// installService attempts to install the hoosatd service. Typically this should
...
// removeService attempts to uninstall the hoosatd service. Typically this should
...
// startService attempts to Start the hoosatd service.
