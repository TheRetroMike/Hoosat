...
type configFlags struct {
	...
	AllowConnectionToDifferentVersions bool   `short:"a" long:"allow-connection-to-different-versions" description:"Allow connections to versions different than hoosatctl's version'"`
...
func parseConfig() (*configFlags, error) {
	...
	parser.Usage = "hoosatctl [OPTIONS] [COMMAND] [COMMAND PARAMETERS].\n\nCommand can be supplied only if --json is not used." +
		"\n\nUse `hoosatctl --list-commands` to get a list of all commands and their parameters." +
