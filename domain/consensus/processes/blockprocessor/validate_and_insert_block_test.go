...
func TestBlockStatus(t *testing.T) {
	testutils.ForAllNets(t, true, func(t *testing.T, consensusConfig *consensus.Config) {
		...
		err = tc.ValidateAndInsertBlock(disqualifiedBlock, true, new(externalapi.DomainHash))
		if err != nil {
...
func TestValidateAndInsertErrors(t *testing.T) {
	...
	testutils.ForAllNets(t, true, func(t *testing.T, consensusConfig *consensus.Config) {
		...
		err = tc.ValidateAndInsertBlock(blockWithStatusInvalid, true, new(externalapi.DomainHash))
		if err == nil {
		...
		err = tc.ValidateAndInsertBlock(onlyHeader, true, new(externalapi.DomainHash))
		if err != nil {
			t.Fatalf("AddBlock: %+v", err)
		}
