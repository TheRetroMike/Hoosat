...
// SignatureScript creates an input signature script for tx to spend HST sent
...
// SignatureScriptECDSA creates an input signature script for tx to spend HST sent
