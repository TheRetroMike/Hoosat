...
// SignatureScript creates an input signature script for tx to spend HSAT sent
...
// SignatureScriptECDSA creates an input signature script for tx to spend HSAT sent
